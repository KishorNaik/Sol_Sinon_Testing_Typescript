...
describe('Demo Test', () => {
    ...
    test(`should return false if guard clause failed`, async () => {
        ...
        const guardStub=sinon.stub(_demoCommandHandler as any,"guard").returns(new Err(new ResultError("Empty request", StatusCodes.BAD_REQUEST)));
    ...
    test(`should return false if guard clause throw exception`, async () => {
        ...
        const guardStub=sinon.stub(_demoCommandHandler as any,"guard").throws(new ResultError("UnExpected Error", StatusCodes.INTERNAL_SERVER_ERROR));
    ...
    test(`should return false if mediator response failed`, async () => {
        ...
        let getMediatorResponseStub= sinon.stub(_demoCommandHandler as any,"getMediatorResponse").returns(new Err(new ResultError("UnExpected Error", StatusCodes.INTERNAL_SERVER_ERROR)));
    ...
    test(`should return false if mediator response throw exception`, async () => {
        ...
        let guardStub=sinon.stub(_demoCommandHandler as any,"guard").returns(new Ok(undefined));
        let getMediatorResponseStub= sinon.stub(_demoCommandHandler as any,"getMediatorResponse").throws(new ResultError("UnExpected Error", StatusCodes.INTERNAL_SERVER_ERROR));
    ...
    test(`should return false if service response failed`, async () => {
        ...
        let guardStub=sinon.stub(_demoCommandHandler as any,"guard").returns(new Ok(undefined));
        let getMediatorResponseStub= sinon.stub(_demoCommandHandler as any,"getMediatorResponse").resolves(new Ok(new DemoMediatorResponseDto()));
        let getServiceResponseStub= sinon.stub(_demoCommandHandler as any,"getServiceResponse").returns(new Err(new ResultError("UnExpected Error", StatusCodes.INTERNAL_SERVER_ERROR)));
    ...
    test(`should return false if service response throw exception`, async () => {
        ...
        let guardStub=sinon.stub(_demoCommandHandler as any,"guard").returns(new Ok(undefined));
        let getMediatorResponseStub= sinon.stub(_demoCommandHandler as any,"getMediatorResponse").resolves(new Ok(new DemoMediatorResponseDto()));
        let getServiceResponseStub= sinon.stub(_demoCommandHandler as any,"getServiceResponse").throws(new ResultError("UnExpected Error", StatusCodes.INTERNAL_SERVER_ERROR));
    ...
    test(`should return false if demo function failed`, async () => {
        ...
        let guardStub=sinon.stub(_demoCommandHandler as any,"guard").returns(new Ok(undefined));
        let getMediatorResponseStub= sinon.stub(_demoCommandHandler as any,"getMediatorResponse").resolves(new Ok(new DemoMediatorResponseDto()));
        let getServiceResponseStub= sinon.stub(_demoCommandHandler as any,"getServiceResponse").resolves(new Ok("test"));
        let demoFunctionStub= sinon.stub(demoFunction,"demoFunction").resolves(new Err(new ResultError("UnExpected Error", StatusCodes.INTERNAL_SERVER_ERROR)));
    ...
    test(`should return false if demo function throws exception`, async () => {
        ...
        let getMediatorResponseStub= sinon.stub(_demoCommandHandler as any,"getMediatorResponse").resolves(new Ok(new DemoMediatorResponseDto()));
        let getServiceResponseStub= sinon.stub(_demoCommandHandler as any,"getServiceResponse").resolves(new Ok("test"));
        let demoFunctionStub= sinon.stub(demoFunction,"demoFunction").throws(new ResultError("UnExpected Error", StatusCodes.INTERNAL_SERVER_ERROR));
